graph [
  ...
  Provenance "Primary"
  Access 0
  Source "http://www.uninett.no/sites/drupal.uninett.no.uninett/files/fnett2b.png"
  Version "1.0"
  Type "REN"
  DateType "Historic"
  Backbone 1
