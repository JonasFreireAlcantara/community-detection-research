...
if __name__ == '__main__':
    path_names = ResourcesUtils.get_list_of_topologies_path(
        os.path.join(ResourcesConstants.DATASET_PATH, 'by_minimum_factor_topologies'))

    for path in path_names:
        _apply_lpa_and_plot_graph(path, '/home/jonas/Desktop/by_minimum_factor_topologies')
