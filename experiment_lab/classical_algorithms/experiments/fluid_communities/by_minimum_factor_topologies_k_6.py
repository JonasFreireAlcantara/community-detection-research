...
if __name__ == '__main__':
    ...
    target = os.path.join('/home/jonas/Desktop/by_minimum_factor_topologies-fluid-communities-k-6')
    metrics = [
        ModularityMetric,
        CoverageMetric,
        PerformanceMetric,
    ...
    classical_runner = PlatformClassicalRunner(
        source, target, AsyncFluidCommunitiesAlgorithm, metrics, number_of_clusters=6)
