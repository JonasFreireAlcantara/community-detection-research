...
class ResilienceSI:
    ...
    def __init__(self, gml_path, file_input, target_directory):
    ...
    def _save_gml_to_directory(self, graph_list):
        ...
        for graph in graph_list:
            GMLWriter(graph, os.path.join(self.target_directory, f'{counter}.gml')).write()
            counter += 1
    ...
    def _save_html_to_directory(self, graph_list):
        ...
        for graph in graph_list:
            ...
            filename = f'{os.path.join(self.target_directory, f"{counter}.html")}'
...
if __name__ == '__main__':
    ...
    file_input = os.path.join(ResourcesConstants.ARNES_RESILIENCE, 'dataset_arnes_shuffle_0.txt')
    ...
    resilience_si = ResilienceSI(gml_path, file_input, target_directory)
